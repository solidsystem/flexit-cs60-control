...
(https://wiki.seeedstudio.com/XIAO-RS485-Expansion-Board/). This expansion
board has no official Zephyr shield definition, so builds do **not** pass
`--shield`; any board-specific peripherals (RS485 transceiver, etc.) must be
declared in `boards/xiao_ble_nrf52840.overlay` if/when wired up.
